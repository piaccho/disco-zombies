...
export const player_state = (() => {
  ...
  class AttackState extends State {
    constructor(parent) {
      ...
      this._swooshSound = new Audio('resources/sounds/swoosh.wav');
      this._swooshSound.loop = false;
      this._swooshSound.volume = 0.3;
    }
    ...
    Enter(prevState) {
      ...
      setTimeout(() => this._swooshSound.play(), 300);
  ...
  class DanceIdleState extends State {
    constructor(parent) {
      super(parent);
    }
    ...
    Enter(prevState) {
      const idleAction = this._parent._proxy._animations['dance_idle'].action;
      if (prevState) {
        const prevAction = this._parent._proxy._animations[prevState.Name].action;
        idleAction.time = 0.0;
        idleAction.enabled = true;
