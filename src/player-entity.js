...
export const player_entity = (() => {
  ...
  class BasicCharacterController extends entity.Component {
    ...
    _Init(params) {
      ...
      this._planeBorder = {x: this._params.dim.width / 2 - borderMargin, z: this._params.dim.depth / 2 - borderMargin};
      this._decceleration = new THREE.Vector3(-0.0005, -0.0001, -5.0);
      this._acceleration = new THREE.Vector3(1, 0.125, 50.0);
      this._velocity = new THREE.Vector3(0, 0, 0);
      this._position = new THREE.Vector3(0, 0, -this._params.dim.depth / 2)
    ...
    _LoadModels() {
      ...
      loader.setPath('./resources/models/fbx/ninja/');
      loader.load('ninja.fbx', (fbx) => {
        ...
        loader.load('kick.fbx', (a) => { _OnLoad('attack', a); });
        loader.load('jump_in_place.fbx', (animation) => { _OnLoad('jump_in_place', animation); });
        loader.load('jump_running.fbx', (animation) => { _OnLoad('jump_running', animation); });
        loader.load('dance.fbx', (animation) => { _OnLoad('dance', animation); });
      });
    }
    ...
    Update(timeInSeconds) {
      ...
      if (pos.x < -this._planeBorder.x || pos.x > this._planeBorder.x || pos.z < -this._planeBorder.z || pos.z > this._planeBorder.z) {
        return;
      }
